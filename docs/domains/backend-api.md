...
> Servers, APIs, databases — Node, Python, Go, Rust, Java, Elixir services.

_Signals that map here: `express`, `fastify`, `hono`, `elysia`, `trpc`, `nestjs`, `django`, `flask`, `fastapi`, `laravel`, `symfony`, `spring`, `axum`, `actix`, `rails`, `gin`, `fiber`, `echo`, `phoenix`, `elixir`, `go.mod`, `Cargo.toml`, `pom.xml`, `prisma`, `drizzle`, `supabase`, `mongodb`, `mongoose`, `sentry`, `postgres`, `graphql`, `redis`_
