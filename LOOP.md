...
**Status: ACTIVE** — Phase 1 stop criteria met at `v0.3.6`. Phase 2 shipped browse/CI/profile/automation UX through `v0.3.80` (MkDocs/Docusaurus/Stripe fixtures). Remaining: optional `NPM_TOKEN` secret and runtime-verified research catalog growth.
...
| Version | Date | Focus |
| :-- | :-- | :-- |
| 0.3.80 | 2026-07-05 | MkDocs/Docusaurus docs + Stripe backend + Elysia guard fixtures |
| 0.3.79 | 2026-07-05 | Swift/Kotlin mobile + docker-compose/yarn/Tailwind fixtures |
| 0.3.78 | 2026-07-05 | uv.lock data-ml + arxiv research + pandas data-ml fixtures |
| 0.3.77 | 2026-07-05 | TensorFlow/scikit-learn data-ml + pnpm monorepo fixtures |
| 0.3.76 | 2026-07-05 | MLflow research + standalone Symfony backend fixtures |
| 0.3.75 | 2026-07-05 | Svelte frontend + Nx devops + W&B research fixtures |
| 0.3.74 | 2026-07-05 | Ansible devops + React Native mobile + Torch data-ml fixtures |
| 0.3.73 | 2026-07-05 | Vue frontend + Unity/Unreal game-dev fixtures |
...
45. Vue frontend + Unity/Unreal game-dev fixtures — ✅ v0.3.73
46. Ansible devops + React Native mobile + Torch data-ml fixtures — ✅ v0.3.74
47. Svelte frontend + Nx devops + W&B research fixtures — ✅ v0.3.75
